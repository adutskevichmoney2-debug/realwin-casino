...
function openAuth(tab='login'){
 ...
 const m=openModal(`<div class="auth">${vis}<div class="auth-form">
  <div class="tabs" style="width:100%;margin-bottom:20px"><button class="tab ${tab==='login'?'act':''}" data-t="login" style="flex:1">${t('a.login')}</button><button class="tab ${tab==='register'?'act':''}" data-t="register" style="flex:1">${t('a.register')}</button></div>
